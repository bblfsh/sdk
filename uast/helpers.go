...
// AllImportPaths returns a list of all import paths in the UAST.
// QualifiedIdentifiers in imports will be concatenated with '/'.
// Resulting import paths will be deduplicated and sorted.
...
func getImportPath(imp nodes.External) (string, bool) {
	...
	default:
		return "", false
		// TODO: automatically build this list using reflection
	case importType,
		runtimeImportType,
		runtimeReImportType,
		inlineImportType:
	}
	var _ Import // may help to find usages
...
func getStringValue(n nodes.External) (string, bool) {
	var _ String // may help to find usages
...
func getIdentifierName(n nodes.External) (string, bool) {
	var _ Identifier // may help to find usages
...
func getAliasNode(n nodes.External) (nodes.External, bool) {
	var _ Alias // may help to find usages

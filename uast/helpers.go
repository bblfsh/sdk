...
//
// The returned import path won't include the imported symbol name. For Java import "com.example.pkg.Ident", only the
// "com/example/pkg" will be listed.
...
func getImportPath(imp nodes.External) (string, bool) {
	...
	case importType, runtimeImportType, runtimeReImportType, inlineImportType:
	}

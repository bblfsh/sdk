...
var (
	errFailedToCreateRelease    = errors.NewKind("%v: failed to create release: %v")
	errFailedToUpdateAllDrivers = errors.NewKind("release failed for one or several drivers, last error: %v")
)

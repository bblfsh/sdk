...
func (s *driverServer) Parse(rctx context.Context, req *ParseRequest) (*ParseResponse, error) {
	...
	if err := toGRPCError(&resp, err); err != nil {
		return nil, err
	}
	err = nil
